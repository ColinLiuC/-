...
{
    public interface IOtherPeopleService : IEfCoreRepository<OtherPeople, OtherPeopleDto>, IServiceSupport
    {

        List<OtherPeopleRegisterDto> GetOtherPeopleInfo(OtherPeopleDto otherpeopleDto, int? sAge, int? eAge, out int total, int pageIndex = 1, int pageSize = 10, int level1 = 0, int level2 = 0, int level3 = 0);
