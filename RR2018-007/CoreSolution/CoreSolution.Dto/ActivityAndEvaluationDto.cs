...
{
    public class ActivityAndEvaluationDto
    {
        public Guid Id { get; set; }//服务申请Id
        public bool isComment { get; set; }//是否评论
        public DateTime CreationTime { get; set; }//活动申请时间
        /// <summary>
        /// 用户市民云Id
        /// </summary>
        ...
        /// <summary>
        /// 活动状态 1-待审核 2-报名中 3-开展中 4-待归档 5-已归档
        /// </summary>
